...
import (
	"context"
	v1 "github.com/galal-hussein/k3s-etcd/pkg/apis/some.api.group/v1"
	foocontroller "github.com/galal-hussein/k3s-etcd/pkg/generated/controllers/some.api.group/v1"
)
